    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        ...
        <section className="mt-10 grid gap-5 sm:grid-cols-3">
          <Card to="/day/$dayId/words" dayId={dayId} emoji="📝" title="단어 관리" desc="단어 추가·수정·삭제, 인쇄/HTML 저장" tone="sky" />
...
}: { to: "/day/$dayId/words" | "/day/$dayId/stage1" | "/day/$dayId/stage2"; dayId: string; emoji: string; title: string; desc: string; tone: "sky" | "mint" | "peach" }) {
  const bg = tone === "sky" ? "bg-sky" : tone === "mint" ? "bg-mint" : "bg-peach";
  return (
    <Link
      to={to}
      params={{ dayId }}
